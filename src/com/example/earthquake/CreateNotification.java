...
public class CreateNotification extends Activity {
   ...
   @TargetApi(Build.VERSION_CODES.JELLY_BEAN) protected void displayNotificationOne() {
   ...
   @TargetApi(Build.VERSION_CODES.JELLY_BEAN) @SuppressLint("NewApi") protected void displayNotificationTwo() {
      // Invoking the default notification service
      NotificationCompat.Builder  mBuilder = new NotificationCompat.Builder(this);	
